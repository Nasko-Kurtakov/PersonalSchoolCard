...
namespace PersonalSchoolCard.Data
{
    ...
    public partial class PersonalSchoolCardEntities : DbContext
    {
        public PersonalSchoolCardEntities()
            : base("name=PersonalSchoolCardEntities")
        {
        }
        ...
        public virtual DbSet<HoursStudiedSubject> HoursStudiedSubjects { get; set; }
